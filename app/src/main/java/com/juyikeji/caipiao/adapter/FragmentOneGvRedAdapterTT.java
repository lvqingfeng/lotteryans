 ...
 */
public class FragmentOneGvRedAdapterTT extends BaseAdapter {
    ...
    boolean aBoolean=true;//胆码够4个的标识

    public FragmentOneGvRedAdapterTT(Context _context, List<Integer> _list,Map<String ,Object> map) {
        this.list = _list;
