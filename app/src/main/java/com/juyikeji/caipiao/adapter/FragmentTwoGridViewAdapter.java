...
public class FragmentTwoGridViewAdapter extends BaseAdapter {
    ...
    public FragmentTwoGridViewAdapter(List<Map<String,String>> list,Context context){
        this.list=list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.fragmenttwo_gridview_item, null);
