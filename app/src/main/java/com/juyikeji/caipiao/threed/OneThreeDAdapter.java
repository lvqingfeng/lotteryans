...
import com.juyikeji.caipiao.arrangefive.OneArrangefiveListGridviewAdapter;
 ...
 */
public class OneThreeDAdapter extends BaseAdapter {
    private Context context;
    private List<Map<String, Object>> listt;
    private int bs;
    private OneThreeDListGridviewAdapter adapter;
    List<String[]> list;
    List<int[]> list1;
    private TextView tv;
    ...
    public OneThreeDAdapter(Context context, List<Map<String, Object>> listt, int bs, TextView tv, EditText edt) {
...
//        hunlist.add(test[2]);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        adapter = new OneThreeDListGridviewAdapter(context, getDate(position), bs);
