 ...
 */
public class LoginFindPwdActivity extends Activity implements View.OnClickListener{
    ...
    //找回密码的网络接口
    private String name_space = Url.LOGINFINDPWD;
    String result = "";
    @Override
        ...
        switch (v.getId()){
            ...
            case R.id.btn_gain:
                ...
                if (!URLConnectionUtil.isOpenNetwork(this)) {
                    Toast.makeText(LoginFindPwdActivity.this, "网络无连接，请检查网络！", Toast.LENGTH_SHORT).show();
                } else {
                    //  通过sdk发送短信验证
    ...
    private void getRegister(String json) {
        try {
            ...
            if (status.equals("1")) {
                Toast.makeText(LoginFindPwdActivity.this, "注册成功", Toast.LENGTH_SHORT).show();
            }else {
                Toast.makeText(LoginFindPwdActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
    ...
    private boolean judgePhoneNums(String phoneNums) {
        ...
        Toast.makeText(LoginFindPwdActivity.this, "手机号码输入有误！", Toast.LENGTH_SHORT).show();
        return false;
    }
