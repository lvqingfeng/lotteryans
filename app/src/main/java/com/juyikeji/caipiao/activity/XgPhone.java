 ...
 * 修改手机号
 */
public class XgPhone extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xg_phone);
    ...
    public void onClick(View v) {
        String phoneNums = et_NewPhone.getText().toString().trim();
        switch (v.getId()) {
            case R.id.fanhui:
                finish();
                break;
            case R.id.bt_code:
                ...
                if (!URLConnectionUtil.isOpenNetwork(this)) {
                    Toast.makeText(XgPhone.this, "网络无连接，请检查网络！", Toast.LENGTH_SHORT).show();
                } else {
                    //  通过sdk发送短信验证
    ...
    private boolean judgePhoneNums(String phoneNums) {
        ...
        Toast.makeText(XgPhone.this, "手机号码输入有误！", Toast.LENGTH_SHORT).show();
        return false;
    }
    ...
    private void request() {
        final String token = SharedPreferencesUtil.getSharedPreferences(XgPhone.this).get("token").toString();
        final String code = et_code.getText().toString();
        final String phone = et_NewPhone.getText().toString();
            ...
            public void handleMessage(Message msg) {
                ...
                if (msg.what == 1) {
                    try {
                        ...
                        Toast.makeText(XgPhone.this, message, Toast.LENGTH_SHORT).show();
