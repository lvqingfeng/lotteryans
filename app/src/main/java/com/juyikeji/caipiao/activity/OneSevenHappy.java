...
public class OneSevenHappy extends Activity implements View.OnClickListener {

    private MyGridView gv_red;
    private FragmentOneGvRedAdapterTT adapterA;
    ...
    protected void onStart() {
        ...
        adapterA = new FragmentOneGvRedAdapterTT(this, getDateR(), getSharedPreferences());
        ...
        if (item >= 0) {
            ...
            int zs = myCombine.combine(s, 7 - d).size();
            if (choose) {
        ...
        if (adapterA.limit+adapterA.limitd >= 7) {
            switch (adapterA.limit) {
                case 7:
                    ...
                    break;
                case 8:
                    tv_money.setText(adapterA.limit + "彩球" + " 共" + 8 + "注 " + 16 + "元");
                    break;
                case 9:
                    tv_money.setText(adapterA.limit + "彩球" + " 共" + 36 + "注 " + 72 + "元");
                    break;
                case 10:
                    tv_money.setText(adapterA.limit + "彩球" + " 共" + 120 + "注 " + 240 + "元");
                    break;
                case 11:
                    tv_money.setText(adapterA.limit + "彩球" + " 共" + 330 + "注 " + 660 + "元");
                    break;
                case 12:
                    tv_money.setText(adapterA.limit + "彩球" + " 共" + 792 + "注 " + 1584 + "元");
                    break;
                case 13:
                    tv_money.setText(adapterA.limit + "彩球" + " 共" + 1716 + "注 " + 3432 + "元");
                    break;
                case 14:
                    tv_money.setText(adapterA.limit + "彩球" + " 共" + 3432 + "注 " + 6864 + "元");
                    break;
                case 15:
                    tv_money.setText(adapterA.limit + "彩球" + " 共" + 6435 + "注 " + 12870 + "元");
                    break;
                case 16:
                    tv_money.setText(adapterA.limit + "彩球" + " 共" + 11440 + "注 " + 22880 + "元");
                    break;
            }
        } else {
    ...
    private void getRegister(String json) {
        try {
            ...
            if (status.equals("1")) {
                ...
                adapter=new FragmentOneKJXXAdapter(this,listis,8);
